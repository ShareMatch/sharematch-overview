...
export default function CTASection() {
  return (
    <section
      id="join"
      className="relative min-h-[80vh] flex items-center justify-center gradient-mesh overflow-hidden pt-20 pb-32 sm:pb-20"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 py-6 border-t border-white/5">
        <div className="section-container">
          <p className="text-xs text-text-muted text-center leading-relaxed max-w-2xl mx-auto">
            ...
            securities. &copy; {new Date().getFullYear()} ShareMatch. All rights
            reserved.
          </p>
        </div>
      </div>
